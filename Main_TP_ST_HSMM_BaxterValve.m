function Main_TP_ST_HSMM_BaxterValve()
...
%%%% show its example to teach Baxter the task of opening a valve from
...
data_path = 'data/BaxterValveDemos2.mat';
load(data_path);
...
model.nbVarPos = 8; %Dimension of position data 
...
model.rfactor = 9E0;
model.varnames = {'x', 'y', 'z', 'qw', 'qx', 'qy', 'qz'};
...
DrawPlotsStateDriven(model, Data, s, r, r_new);
